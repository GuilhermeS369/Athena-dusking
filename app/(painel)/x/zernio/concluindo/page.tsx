...
export default async function TwitterCompletingPage({ searchParams }: { searchParams: Promise<{ intent?: string }> }) {
  ...
  return <TwitterConnectProgress intentId={intent} completion />;
}
