...
PUBLICATION_WORKER_HEARTBEAT_INTERVAL_MS=30000
...
ZERNIO_SYNC_WORKER_POLL_INTERVAL_MS=5000
ZERNIO_SYNC_WORKER_LIMIT=3
...
Comece com `ZERNIO_SYNC_WORKER_LIMIT=3`. Aumente somente após acompanhar tempo de ciclo, respostas de limite da Zernio e número de retries. Leases vencidos são retomáveis: outro ciclo pode reivindicar o item sem reiniciar o lote inteiro.
...
PUBLICATION_GENERATION_WORKER_HEARTBEAT_INTERVAL_MS=30000
...
PUBLICATION_GENERATION_WORKER_BULK_STEP_SIZE=500
...
MEDIA_MAINTENANCE_WORKER_HEARTBEAT_INTERVAL_MS=30000
