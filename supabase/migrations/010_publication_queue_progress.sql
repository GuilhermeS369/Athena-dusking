-- Athena Scheduler: registra contêineres em processamento sem manter um worker bloqueado.
...
begin
  ...
  where publication_items.id = item_row.id
  returning publication_items.id, publication_items.status,
    publication_items.creation_id, publication_items.next_attempt_at;
end;
$$;
