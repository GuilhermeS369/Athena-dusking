-- Corrige referência ambígua introduzida quando a função passou a retornar batch_id.
-- Sem esta qualificação, nenhum worker consegue reivindicar itens prontos/agendados.
