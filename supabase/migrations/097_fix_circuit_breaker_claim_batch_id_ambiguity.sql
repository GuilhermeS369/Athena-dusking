-- A função retorna uma coluna OUT chamada batch_id. Dentro do CTE de atualização
-- do lote, a referência precisa apontar explicitamente para o CTE claimed para
-- não conflitar com essa variável PL/pgSQL quando existir item elegível.
