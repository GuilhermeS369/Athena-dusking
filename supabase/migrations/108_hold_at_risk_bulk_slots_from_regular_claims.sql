-- Um slot coletivo em risco não pode voltar ao fluxo de claim normal antes de
-- uma decisão coordenada de recuperação. Isso evita uma avalanche tardia que
-- concorra com o próximo slot coletivo ou com outras organizações.
