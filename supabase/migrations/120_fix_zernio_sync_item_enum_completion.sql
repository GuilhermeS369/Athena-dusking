-- A conclusão do item também atualiza uma coluna enum por CASE. Sem casts
-- explícitos, o PostgreSQL infere text e o worker entra em ciclo de reinício
-- com 42804 antes de conseguir persistir sucesso, falha ou retry.
...
revoke all on function public.complete_zernio_sync_batch_item(uuid, text, integer, integer, text) from public, anon, authenticated;
grant execute on function public.complete_zernio_sync_batch_item(uuid, text, integer, integer, text) to service_role;
