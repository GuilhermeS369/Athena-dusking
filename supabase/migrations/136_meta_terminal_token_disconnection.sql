-- Erro Meta 190 com checkpoint/login obrigatório representa queda terminal do
-- perfil. Encerra apenas o escopo desse perfil como ignored e o remove
-- logicamente do Athena, preservando mídias, histórico e os demais perfis.
...
revoke all on function public.finalize_meta_profile_disconnection(uuid, text, text, text, integer)
from public, anon, authenticated;
grant execute on function public.finalize_meta_profile_disconnection(uuid, text, text, text, integer)
to service_role;
