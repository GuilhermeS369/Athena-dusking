-- Migration: Schedule Zernio profile disconnection during sync / health checks
-- Allows disconnection incidents and recycling jobs to be scheduled directly
-- when an account is marked inactive / disconnected by Zernio.
