-- Promove em bloco itens já validados cuja mídia compartilhada está pronta.
-- Evita N leituras/RPCs por perfil quando milhares de itens usam o mesmo arquivo.

create or replace function public.promote_cached_zernio_media_preparation(p_limit integer default 2000)
returns integer
language plpgsql
security definer
